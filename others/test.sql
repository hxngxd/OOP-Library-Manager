...
VALUES 
(1, 8, 2, 'Cuốn sách này giúp tôi hiểu thêm về lịch sử.'),
...
(5, 2, 3, 'Sách này có một vài đoạn hơi khó hiểu, nhưng tổng thể rất tốt.'),
...
(9, 2, 2, 'Nội dung đơn giản nhưng vẫn có những điểm thú vị.'),
...
(5, 2, 5, 'Đây là cuốn sách đáng đọc nhất mà tôi từng gặp.'),
...
(13, 2, 4, 'Cốt truyện cuốn hút, các nhân vật được phát triển tuyệt vời.'),
...
(26, 2, 1, 'Nội dung hơi khó hiểu và kém hấp dẫn.'),
...
(39, 2, 3, 'Cuốn sách có phần hơi dài dòng nhưng nội dung ý nghĩa.'),
